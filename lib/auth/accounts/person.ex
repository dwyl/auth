defmodule Auth.Accounts.Person do
  use Ecto.Schema
  ...
  @doc """
  A person changeset for registration.
  ...
  @doc """
  A person changeset for changing the email.
  ...
  """
  def valid_password?(%Auth.Accounts.Person{hashed_password: hashed_password}, password)
