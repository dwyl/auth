defmodule AuthWeb.PersonAuth do
  ...
  def log_out_person(conn) do
    ...
    person_token && Accounts.delete_person_session_token(person_token)
  ...
  the current_person:
      ...
      defmodule AuthWeb.PageLive do
        ...
        on_mount {AuthWeb.PersonAuth, :mount_current_person}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AuthWeb.PersonAuth, :ensure_authenticated}] do
        live "/profile", ProfileLive, :index
      end
  """
  def on_mount(:mount_current_person, _params, session, socket) do
    {:cont, mount_current_person(session, socket)}
  end
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_person do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/people/log_in")
  ...
  defp mount_current_person(session, socket) do
